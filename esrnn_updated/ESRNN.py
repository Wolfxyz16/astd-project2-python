  ...
  def train(self, dataloader, max_epochs,
    ...
    for epoch in range(max_epochs):
      ...
      for j in range(dataloader.n_batches):
        ...
        scaler.unscale_(self.rnn_optimizer)
        scaler.unscale_(self.es_optimizer)
        ...
        scaler.step(self.rnn_optimizer)
        scaler.step(self.es_optimizer)
        scaler.update()
      ...
      if (epoch % self.mc.freq_of_test == 0) and (self.mc.freq_of_test > 0):
        if self.y_test_df is not None:
          ...
          self.esrnn.train()
      del batch, windows_y, windows_y_hat, loss
